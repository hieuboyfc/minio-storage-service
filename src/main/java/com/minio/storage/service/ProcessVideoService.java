...
import com.minio.storage.factory.FFmpegBuilderFactory;
...
public class ProcessVideoService {
    ...
    public CompletableFuture<?> processVideo(MultipartFile file, VideoSettingRequest request) {
    ...
    public CompletableFuture<?> convertVideoFormat(MultipartFile file, VideoSettingRequest request) {
    ...
    public CompletableFuture<?> createVideoThumbnail(String videoPath, long timeInSeconds) {
        return CompletableFuture.supplyAsync(() -> {
            try {
